...
__all__ = [
    'SDTProperty', 'DISPID_SRGRules', 'DISPID_SRRAudioFormat',
    'SpMMAudioOut', 'DISPID_SPRules_NewEnum',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechRecoResult2',
    'SPPHRASEELEMENT', 'SVF_Emphasis', 'SAFT22kHz16BitMono',
    'ISpSerializeState', 'SAFTCCITT_uLaw_8kHzMono', 'SASPause',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechObjectToken',
    'ISpeechResourceLoader', 'SPDKL_DefaultLocation', 'SLODynamic',
    'DISPID_SPIRetainedSizeBytes', 'SVEEndInputStream',
    'SPEI_HYPOTHESIS', 'SpeechPropertyHighConfidenceThreshold',
    'SDTPronunciation', 'DISPID_SOTIsUISupported', 'SP_VISEME_16',
    'SPRECOCONTEXTSTATUS', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPERequiredConfidence', 'SPVOICESTATUS',
    'eLEXTYPE_MORPHOLOGY', 'eLEXTYPE_PRIVATE3', 'DISPID_SVEBookmark',
    'DISPID_SDKEnumKeys', 'SPAUDIOSTATE',
    'DISPID_SRSCurrentStreamNumber', 'SpeechAudioVolume',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseElements',
    ...
    'DISPID_SPCIdToPhone', 'DISPID_SVGetAudioInputs', 'WAVEFORMATEX',
    'SpeechTokenValueCLSID', 'DISPID_SABIBufferSize', 'SPFILEMODE',
    'SPSNoun', 'SECFIgnoreKanaType', 'SPEI_MIN_TTS',
    'DISPID_SVDisplayUI', 'SVP_4', 'DISPID_SLWLangId',
    'DISPID_SLPSymbolic', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRGRecoContext', 'DISPID_SPRFirstElement',
    'SVSFPurgeBeforeSpeak', 'SPGRAMMARWORDTYPE',
    'DISPID_SOTGetAttribute', 'DISPID_SVSpeakStream',
    'SAFTCCITT_ALaw_44kHzMono', 'SPPARTOFSPEECH',
    'DISPID_SVEAudioLevel', 'SAFTADPCM_44kHzMono',
    'SAFT12kHz8BitStereo', 'DISPID_SpeechGrammarRule', 'SPRECOSTATE',
    'eLEXTYPE_USER_SHORTCUT', 'SPSTREAMFORMATTYPE',
    'DISPID_SWFEBitsPerSample', 'SPSHT_NotOverriden',
    'DISPID_SRCEBookmark', 'DISPID_SCSBaseStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SMSAMMHandle',
    'SECLowConfidence', 'DISPID_SGRSRule',
    'DISPID_SVSpeakCompleteEvent', 'SpeechLexiconType', 'SINoise',
    'SpVoice', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechWaveFormatEx', 'SPEI_SOUND_START', 'SRAImport',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWORD', 'SP_VISEME_21',
    'DISPID_SOTRemoveStorageFileName', 'STCRemoteServer',
    'SPEI_PHONEME', 'SRSActive', 'SPEI_PHRASE_START', 'SVP_1',
    'SPPS_RESERVED3', 'SREBookmark', 'SPSLMA',
    'DISPID_SRGCmdLoadFromFile', 'Library', 'DISPID_SVSPhonemeId',
    'ISpeechAudioStatus', 'SP_VISEME_20', 'SPEI_RESERVED5',
    'DISPID_SDKCreateKey', 'DISPID_SMSALineId', 'eLEXTYPE_USER',
    'DISPID_SGRSTransitions', 'SVPOver', 'SAFTExtendedAudioFormat',
    'DISPID_SRGetFormat', 'UINT_PTR', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRGId', 'DISPID_SVPriority', 'DISPID_SAFGetWaveFormatEx',
    'SAFT44kHz16BitMono', 'SVP_20', 'SBOPause', 'DISPID_SGRsItem',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPIElements',
    'SPEI_MAX_TTS', 'SRSInactiveWithPurge',
    'IInternetSecurityManager', 'SAFTADPCM_11kHzStereo',
    'DISPID_SDKDeleteValue', 'ISpStreamFormat',
    'DISPID_SRRTStreamTime', 'ISpObjectToken', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechDisplayAttributes', 'SRERecoOtherContext',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechRecoProfileProperties',
    'STSF_CommonAppData', 'SpeechStreamFileMode',
    'Speech_Default_Weight', 'SFTSREngine', 'SRARoot',
    'STSF_FlagCreate', 'DISPID_SRRTLength', 'SPVISEMES',
    'DISPID_SPRuleConfidence', 'SAFTGSM610_44kHzMono',
    'Speech_StreamPos_Asap', 'ISpeechMMSysAudio', 'SAFT8kHz8BitMono',
    'DISPID_SVGetVoices', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPEActualConfidence',
    'DISPID_SRCState', 'SpLexicon', 'SPPS_Modifier', 'DISPID_SOTCId',
    'SpeechTokenIdUserLexicon', 'SVSFParseMask', 'SPFM_CREATE',
    'SVP_3', 'SP_VISEME_17', 'SPTEXTSELECTIONINFO',
    'SpeechUserTraining', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVWaitUntilDone',
    'SPFM_NUM_MODES', 'SpObjectTokenCategory', 'SPPS_RESERVED1',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRSCurrentStreamPosition', 'SPWT_LEXICAL',
    'SAFTCCITT_uLaw_22kHzMono', 'SPRS_INACTIVE',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPPValue', 'tagSTATSTG',
    'SpeechCategoryAppLexicons', 'SPDATAKEYLOCATION',
    'SPEI_ADAPTATION', 'DISPID_SPIGetText', 'SPPS_Verb',
    'DISPID_SpeechCustomStream', 'DISPID_SVResume',
    'SDKLCurrentConfig', 'SpNullPhoneConverter', 'ISpeechObjectToken',
    'DISPID_SLWs_NewEnum', 'DISPID_SWFESamplesPerSec',
    'SVSFParseSapi', 'SpeechPartOfSpeech',
    'ISpeechLexiconPronunciations', 'DISPID_SLGetGenerationChange',
    'SAFT44kHz16BitStereo', 'DISPID_SVSkip', 'DISPID_SRSClsidEngine',
    'SpeechPropertyResourceUsage',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SGRsCommit',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRsCount',
    'DISPID_SGRSTPropertyValue', 'SRCS_Enabled',
    'ISpeechLexiconPronunciation', 'STCInprocServer',
    'DISPID_SpeechRecoResult', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SDTRule', 'SpStreamFormatConverter', 'SP_VISEME_1',
    'ISpeechAudio', 'SRTEmulated', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_RESERVED7',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechLoadOption',
    'DISPID_SABIMinNotification', 'SAFTCCITT_ALaw_22kHzMono',
    'SPSNotOverriden', 'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SLPLangId',
    'SDTDisplayText', 'SpeechRunState', 'DISPID_SVVolume',
    'DISPID_SLWWord', 'SpeechCategoryPhoneConverters',
    'DISPID_SLWsCount', 'DISPID_SVEPhoneme', 'DISPID_SPIProperties',
    'SPEI_SOUND_END', 'SPCONTEXTSTATE', 'SPAUDIOBUFFERINFO',
    'ISpeechPhraseRules', 'DISPID_SPRulesCount', 'DISPID_SPACommit',
    'SRSEIsSpeaking', 'DISPID_SRRTTickCount', 'SPEI_VISEME',
    'SPEVENTSOURCEINFO', 'eWORDTYPE_ADDED',
    'DISPID_SpeechMemoryStream', 'DISPID_SVEStreamStart',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRCEHypothesis',
    'SITooQuiet', 'SDA_No_Trailing_Space', 'SpInprocRecognizer',
    'DISPID_SBSRead', 'DISPID_SpeechPhraseProperty',
    'ISpeechObjectTokenCategory', 'SpFileStream', 'SITooFast',
    'SPEI_END_INPUT_STREAM', 'DISPID_SDKGetStringValue',
    'SPPHRASERULE', 'SECNormalConfidence', 'eLEXTYPE_PRIVATE6',
    'SVP_18', 'SpMMAudioIn', 'DISPID_SRCEPhraseStart',
    'DISPID_SOTDisplayUI', 'SpeechAddRemoveWord',
    'DISPID_SpeechPhraseReplacements', 'SGPronounciation', 'SASStop',
    'SpeechRecognitionType', 'DISPID_SpeechAudioFormat',
    'ISpRecoGrammar2', 'SAFT12kHz16BitStereo', 'SPEVENTENUM',
    'SP_VISEME_12', 'SpeechAudioFormatType', 'DISPID_SRCEStartStream',
    ...
    'DISPID_SRCESoundStart', 'SVP_2', 'SAFT44kHz8BitStereo',
    'SpeechStreamSeekPositionType', 'SVEPrivate', 'SPPS_NotOverriden',
    'SPSModifier', 'SpeechEngineProperties', 'ISpObjectTokenCategory',
    'DISPID_SPERetainedSizeBytes', 'SVP_13',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechPhraseInfoBuilder',
    'SAFT11kHz16BitStereo', 'SRADefaultToActive',
    'SPWORDPRONOUNCEABLE', 'SREAudioLevel', 'DISPID_SVAudioOutput',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPCLangId',
    'DISPID_SDKGetlongValue', 'SSFMOpenReadWrite', 'DISPID_SGRSTRule',
    'SPSERIALIZEDRESULT', 'SAFTNoAssignedFormat', 'SVP_19',
    'DISPID_SLPPhoneIds', 'ISpeechCustomStream', 'SVP_15',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPVPRI_NORMAL',
    'SAFT24kHz8BitStereo', 'DISPID_SLPsCount', 'SLTUser',
    'DISPID_SPEsCount', 'ISpeechAudioBufferInfo',
    'SPEI_END_SR_STREAM', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPPs_NewEnum', 'SpeechRecognizerState',
    'DISPID_SLGetPronunciations', 'ISpPhrase',
    'DISPID_SOTGetStorageFileName', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPRuleId', 'DISPID_SRCEFalseRecognition',
    'SPAUDIOOPTIONS', 'DISPID_SLWType', 'SPWF_SRENGINE',
    'SpPhoneticAlphabetConverter', 'SDKLDefaultLocation',
    'SpeechVoiceEvents', 'SDA_Consume_Leading_Spaces', 'SVP_8',
    'ISpStreamFormatConverter', 'ISpeechDataKey', 'ISpRecoCategory',
    'ISpeechXMLRecoResult', 'SREHypothesis',
    'DISPID_SVSInputWordPosition', 'SVEWordBoundary', 'SPAS_PAUSE',
    'SRSActiveAlways', 'STCInprocHandler', 'Speech_Max_Pron_Length',
    'ISpObjectWithToken', 'SRADynamic', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechAudio',
    'DISPID_SVSLastStreamNumberQueued', 'ISpXMLRecoResult',
    'SPSSuppressWord', 'SVSFDefault', 'SpeechTokenContext',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRProfile',
    'DISPID_SVEventInterests', 'SAFT48kHz16BitMono',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SLPType', 'ISpeechPhraseInfo', 'DISPID_SRDisplayUI',
    'SECFDefault', 'SPPS_SuppressWord', 'SAFTCCITT_ALaw_11kHzMono',
    'SpPhoneConverter', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_4', 'SVP_16', 'DISPID_SPANumberOfElementsInResult',
    'SGSEnabled', 'eLEXTYPE_PRIVATE20', 'DISPID_SRCEEndStream',
    'SPPS_Unknown', 'DISPID_SpeechGrammarRules', 'SPSMF_UPS',
    'DISPID_SMSADeviceId', 'DISPIDSPRG',
    'DISPID_SRRDiscardResultInfo', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SGRSTType', 'SVP_10', 'SpeechTokenKeyAttributes',
    'SPPS_Function', 'eLEXTYPE_PRIVATE11', 'SpeechRecoContextState',
    'DISPID_SGRsCommitAndSave', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechAudioFormat', 'SINoSignal', 'SPGS_EXCLUSIVE',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpRecognizer',
    'DISPID_SVEStreamEnd', 'DISPID_SPRuleName',
    'DISPID_SpeechAudioStatus', 'DISPID_SPRuleParent',
    'DISPID_SRCRetainedAudio', 'DISPID_SpeechMMSysAudio',
    'SPWORDTYPE', 'DISPID_SDKEnumValues', 'SPCS_ENABLED',
    'eLEXTYPE_PRIVATE15', 'SpInProcRecoContext',
    'DISPID_SRCRetainedAudioFormat', 'SpMemoryStream',
    'SPRST_INACTIVE', 'SREFalseRecognition', 'SPEI_RESERVED3',
    'DISPID_SDKGetBinaryValue', 'SSFMCreate', 'SPEI_RECOGNITION',
    'SRTStandard', 'DISPID_SpeechDataKey', '_ISpeechVoiceEvents',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechGrammarRuleState',
    'SpeechDiscardType', 'eLEXTYPE_RESERVED8', 'DISPID_SRGReset',
    'SVP_21', 'DISPID_SpeechPhraseAlternate',
    ...
    'SAFT11kHz8BitStereo', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCEAdaptation',
    'SpeechWordType', 'SPDKL_CurrentConfig', 'SSSPTRelativeToEnd',
    'DISPID_SPRuleEngineConfidence', 'ISpPhraseAlt', 'SRERecognition',
    'DISPID_SPIGrammarId', 'ISpeechRecoResult', 'SSFMOpenForRead',
    'DISPID_SOTCreateInstance', 'SPWORDLIST', 'SRESoundStart',
    'eLEXTYPE_PRIVATE2', 'SPSERIALIZEDPHRASE', 'SAFTADPCM_8kHzMono',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'SPAR_High', 'SRATopLevel',
    'SPCT_COMMAND', 'DISPID_SpeechObjectTokens', 'DISPID_SVEViseme',
    'DISPID_SpeechVoiceEvent', 'STSF_LocalAppData', 'DISPID_SVVoice',
    '__MIDL_IWinTypes_0009', 'DISPID_SVAlertBoundary',
    'ISpPhoneConverter', 'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_14',
    'SPINTERFERENCE_NONE', 'SVESentenceBoundary',
    'SAFTADPCM_22kHzMono', 'ISpRecoGrammar', 'SDA_One_Trailing_Space',
    'SPFM_OPEN_READWRITE', 'SPSHORTCUTPAIRLIST', 'SVP_6',
    ...
    'DISPID_SVSInputSentencePosition', 'SPEI_SR_AUDIO_LEVEL', 'SVP_0',
    'ISpNotifySource', 'typelib_path', 'SVSFlagsAsync',
    'SPSHORTCUTTYPE', 'ISpRecognizer2', 'DISPID_SpeechVoice',
    'SWTAdded', 'SpeechVisemeType', 'DISPID_SOTCGetDataKey',
    'SGDSActive', 'SPBO_AHEAD', 'SPRECOGNIZERSTATUS', 'SPWF_INPUT',
    'ISpeechPhraseElement', 'SpeechRegistryUserRoot', 'ISpDataKey',
    'ISpLexicon', 'DISPID_SWFEExtraData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVSFUnusedFlags',
    'DISPID_SPARecoResult', 'SAFT8kHz16BitMono', 'DISPID_SBSFormat',
    'DISPID_SVAudioOutputStream', 'DISPID_SLGenerationId',
    '_RemotableHandle', 'SPFM_OPEN_READONLY',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVSFVoiceMask',
    'ISpGrammarBuilder', 'SPRS_ACTIVE_USER_DELIMITED', 'SGSDisabled',
    'DISPID_SBSWrite', 'DISPID_SRRGetXMLResult', 'SRTReSent',
    'STSF_AppData', 'ISpeechGrammarRules', 'DISPID_SAStatus',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVEVoiceChange', 'ISpAudio', 'SP_VISEME_2',
    'DISPID_SOTRemove', 'DISPID_SRRecognizer', 'SPDKL_LocalMachine',
    'SpeechVoiceSpeakFlags', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_RESERVED6', 'SpTextSelectionInformation', 'SRSInactive',
    'DISPID_SPRs_NewEnum', 'DISPID_SAVolume',
    'DISPID_SpeechRecognizer', 'DISPID_SGRId', 'SPCATEGORYTYPE',
    'SPCS_DISABLED', 'SINone', 'DISPID_SpeechPhraseInfo',
    'DISPID_SOTCSetId', 'DISPID_SGRAddResource', 'DISPID_SVRate',
    'SP_VISEME_3', 'DISPID_SOTsCount', 'SPLEXICONTYPE',
    'DISPID_SPPName', 'SpeechRuleAttributes', 'SP_VISEME_8',
    'SPXRO_Alternates_SML', 'DISPID_SWFEBlockAlign',
    'SAFTADPCM_22kHzStereo', 'SPSHT_OTHER',
    'DISPID_SpeechRecoContextEvents', 'SASClosed', 'SVPNormal',
    'SPPS_RESERVED2', 'DISPID_SPIEngineId', 'DISPID_SASetState',
    'SpWaveFormatEx', 'SPPS_RESERVED4', 'SAFT22kHz8BitStereo',
    'DISPID_SPRuleChildren', 'DISPIDSPTSI_ActiveLength', 'SAFTText',
    'SPRST_ACTIVE', 'DISPID_SRCEPropertyStringChange', 'SP_VISEME_11',
    'DISPID_SLAddPronunciation', 'DISPID_SRRAlternates',
    'SAFTGSM610_11kHzMono', 'SPBO_NONE', 'SREAdaptation',
    'Speech_Max_Word_Length', 'DISPID_SABufferNotifySize',
    'SAFT16kHz16BitMono', 'DISPID_SASFreeBufferSpace',
    'SAFTADPCM_11kHzMono', 'SpeechTokenKeyFiles',
    'SAFT12kHz16BitMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpRecoResult', 'SPAS_STOP', 'DISPID_SPAs_NewEnum',
    'DISPID_SRCERecognitionForOtherContext', 'ISpMMSysAudio',
    'DISPID_SADefaultFormat', 'SVSFParseSsml',
    'DISPID_SGRSTNextState', 'ISpRecoContext2', 'DISPID_SAFType',
    'DISPID_SVSRunningState', 'ISpeechPhraseAlternate',
    'SPSHORTCUTPAIR', 'DISPID_SGRSTs_NewEnum', 'SGRSTTDictation',
    'DISPID_SRCERecognizerStateChange', 'Speech_StreamPos_RealTime',
    'SDKLLocalMachine', 'SAFT48kHz8BitMono',
    'DISPID_SRGetRecognizers', 'eLEXTYPE_RESERVED9', 'SPCT_DICTATION',
    'SPPHRASEREPLACEMENT', 'DISPID_SAEventHandle',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPISaveToMemory',
    'SpeechVisemeFeature',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechRegistryLocalMachineRoot', 'SPAR_Low',
    'DISPID_SRGSetTextSelection', 'DISPID_SVSLastBookmark',
    'SPAR_Unknown', 'SPRULE', 'DISPID_SLWsItem',
    'DISPID_SRCRecognizer', 'SVPAlert', '_SPAUDIOSTATE',
    'SPEI_WORD_BOUNDARY', 'DISPID_SLPs_NewEnum',
    'SAFT48kHz16BitStereo', 'SpCompressedLexicon', 'SRTSMLTimeout',
    'SVEAudioLevel', 'SAFT32kHz16BitMono', 'SAFT12kHz8BitMono',
    'SpeechCategoryRecognizers', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseRules', 'SPSHT_Unknown',
    'SAFT48kHz8BitStereo', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechRecoContext', 'SDTAlternates',
    'DISPID_SpeechPhoneConverter', 'SpeechCategoryAudioIn',
    'DISPID_SRCESoundEnd', 'SREAllEvents', 'SRAInterpreter',
    'SAFT24kHz16BitStereo', 'SVSFIsFilename', 'SECFNoSpecialChars',
    'DISPID_SRStatus', 'eLEXTYPE_PRIVATE7', 'DISPID_SRCBookmark',
    'SpeechCategoryRecoProfiles', 'DISPID_SGRInitialState',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhraseProperty', 'SDA_Two_Trailing_Spaces',
    'SpeechVoiceCategoryTTSRate', 'eLEXTYPE_PRIVATE12',
    'DISPID_SOTs_NewEnum', 'SVP_5', 'SPLO_STATIC',
    'SPINTERFERENCE_NOSIGNAL', 'SPAR_Medium', 'DISPID_SPAPhraseInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechFileStream', 'SpMMAudioEnum',
    'SSSPTRelativeToCurrentPosition', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRRTimes',
    'DISPID_SpeechLexiconProns', 'SGDisplay', 'SFTInput',
    'DISPID_SPRsCount', 'DISPID_SVSyncronousSpeakTimeout',
    'SVEVoiceChange', 'SVEPhoneme', 'DISPID_SRSetPropertyString',
    'DISPID_SOTGetDescription', 'SPEI_SR_PRIVATE', 'SITooSlow',
    'SpObjectToken', 'SREPropertyStringChange', 'eLEXTYPE_PRIVATE18',
    'SGSExclusive', 'SECFIgnoreWidth', 'SP_VISEME_9', 'SGLexical',
    'SPWT_DISPLAY', 'DISPID_SVSVisemeId',
    'DISPID_SPIEnginePrivateData', 'SGRSTTEpsilon', 'SPBINARYGRAMMAR',
    'DISPID_SpeechVoiceStatus', 'SREPropertyNumChange',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_TTS_PRIVATE', 'SPSHT_EMAIL',
    'eLEXTYPE_RESERVED4', 'DISPID_SGRSTsCount', 'DISPID_SPRulesItem',
    'SRTExtendableParse', 'DISPID_SDKOpenKey', 'SpeechMicTraining',
    'ISpeechPhraseReplacement', 'SGRSTTTextBuffer',
    'ISpeechWaveFormatEx', 'DISPID_SRRPhraseInfo', 'SASRun',
    'SPRS_ACTIVE', 'DISPID_SPAStartElementInResult',
    'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE13', 'SPPROPERTYINFO',
    'SSFMCreateForWrite', 'ISpeechRecognizerStatus', 'SPVPRI_OVER',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_PRIVATE5',
    'SPEI_VOICE_CHANGE', 'SVP_17', 'SPEI_PROPERTY_NUM_CHANGE',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRRAudio', 'SGRSTTRule', 'DISPID_SGRAddState',
    'SpNotifyTranslator', 'DISPID_SABIEventBias',
    'eLEXTYPE_PRIVATE16', 'SpeechRetainedAudioOptions',
    'DISPID_SPIStartTime', 'SREPrivate', 'DISPID_SGRName',
    'SPPS_Noncontent', 'DISPID_SpeechLexiconWords',
    'SAFT44kHz8BitMono', 'SPEI_RESERVED1', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'SPCT_SUB_DICTATION', 'SP_VISEME_6',
    'SPRECORESULTTIMES', 'SVP_12', 'SpeechEmulationCompareFlags',
    'ISpeechRecognizer', 'SAFT32kHz8BitStereo', 'DISPID_SPIRule',
    'SPEVENT', 'ISpRecognizer3', 'SPINTERFERENCE', 'SPEI_SR_BOOKMARK',
    'SPEI_TTS_BOOKMARK', 'DISPID_SDKDeleteKey', 'ISpeechRecoGrammar',
    'DISPID_SVSLastResult', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPEs_NewEnum', 'STCLocalServer', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechAudioState', 'SP_VISEME_0', 'DISPID_SVSpeak',
    'DISPID_SVGetProfiles', 'DISPID_SPEAudioSizeBytes',
    'SP_VISEME_15', 'SAFTNonStandardFormat', 'SP_VISEME_18',
    'SPPS_Noun', 'SECFIgnoreCase', 'DISPID_SOTId',
    'SAFTGSM610_22kHzMono', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSFunction', 'SRESoundEnd', 'ISpeechRecoResult2',
    'SGDSActiveUserDelimited', 'SVEStartInputStream', 'SVP_14',
    'SDTAll', 'DISPID_SRGState', 'DISPID_SDKSetStringValue',
    'DISPID_SRIsUISupported', 'DISPID_SVEWord',
    'SPEI_START_SR_STREAM', 'DISPID_SPPEngineConfidence',
    'DISPID_SGRSTText', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE9',
    'SpeechAllElements', 'SPCT_SUB_COMMAND', 'DISPID_SPPFirstElement',
    'SPSEMANTICERRORINFO', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SVGetAudioOutputs', 'SAFT32kHz16BitStereo',
    'SpAudioFormat', 'SWTDeleted', 'SPXMLRESULTOPTIONS',
    'ISpeechPhraseElements', 'DISPID_SRCEventInterests',
    'SSTTDictation', 'DISPID_SRGCommit', 'DISPID_SpeechLexiconWord',
    'DISPID_SGRSTWeight', 'SGRSTTWildcard', 'SREPhraseStart',
    'DISPID_SASCurrentDevicePosition', 'SITooLoud',
    'ISequentialStream', 'ISpVoice', 'DISPID_SGRsFindRule',
    'SpeechInterference', 'DISPID_SPPsItem', 'DISPID_SpeechLexicon',
    'ISpProperties', 'SPCT_SLEEP', 'eWORDTYPE_DELETED',
    'SREStreamEnd', 'ISpRecoContext', 'SRCS_Disabled',
    'ISpeechMemoryStream', 'SPAO_RETAIN_AUDIO', 'DISPID_SVStatus',
    'SVP_7', 'DISPID_SRGetPropertyString', 'SPRULESTATE',
    'DISPID_SPPNumberOfElements', 'SVEViseme', 'SREInterference',
    'SpeechTokenShellFolder', 'SSTTWildcard',
    'DISPID_SRCAudioInInterferenceStatus', 'SGDSInactive',
    'ISpStream', 'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE4', 'SRTAutopause',
    'ISpeechPhraseAlternates', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPGS_DISABLED',
    'SVSFNLPSpeakPunc', 'SPWORDPRONUNCIATION', 'SP_VISEME_5',
    ...
    'IStream', 'SSTTTextBuffer', 'SpeechRecoEvents',
    'DISPID_SRCreateRecoContext', 'DISPID_SPEDisplayAttributes',
    'DISPID_SVSInputSentenceLength', 'SpeechDataKeyLocation',
    'SRAExport', 'DISPID_SRCRequestedUIType', 'SP_VISEME_19',
    'ISpeechVoiceStatus', 'DISPID_SWFEChannels',
    'SPADAPTATIONRELEVANCE', 'SPBO_PAUSE',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGDictationLoad',
    'IEnumSpObjectTokens', 'SGRSTTWord', 'SAFT16kHz8BitStereo',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SLGetWords',
    'ISpeechPhraseProperties', 'SREStreamStart',
    'SpSharedRecoContext', 'SPEI_MAX_SR', 'SpeechTokenKeyUI',
    'DISPID_SOTSetId', 'SPDKL_CurrentUser', 'SPEI_INTERFERENCE',
    'SVP_11', 'SDTReplacement', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPINTERFERENCE_TOOSLOW', 'SVEBookmark', 'SAFT24kHz8BitMono',
    'SVSFNLPMask', 'SAFTADPCM_8kHzStereo', 'DISPID_SRRSaveToMemory',
    'DISPID_SPRText', 'SPEI_RESERVED2', 'SpResourceManager',
    'SBONone', 'DISPID_SPEAudioStreamOffset', 'DISPID_SPPConfidence',
    'SpeechBookmarkOptions', 'DISPID_SLPsItem', 'SVF_None',
    'ISpeechPhraseReplacements', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRGCmdLoadFromObject', 'SpeechRuleState',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseElement',
    'SECFEmulateResult', 'ISpeechLexiconWord',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWAVEFORMATTYPE',
    'SAFT11kHz8BitMono', 'SpeechDictationTopicSpelling',
    'DISPID_SWFEFormatTag', 'SRAORetainAudio',
    'SpeechAudioFormatGUIDText', 'SPSMF_SAPI_PROPERTIES',
    'SpeechCategoryAudioOut', 'STCAll', 'DISPID_SPEAudioTimeOffset',
    'ISpeechPhraseRule', 'DISPID_SPRsItem', 'DISPID_SpeechBaseStream',
    'SPAO_NONE', 'DISPID_SpeechPhraseBuilder',
    'SpeechPropertyAdaptationOn', 'SVP_9', 'SAFT32kHz8BitMono',
    'SPPS_LMA', 'SPPHRASEPROPERTY', 'DISPID_SRState',
    'tagSPPROPERTYINFO', 'SAFTCCITT_ALaw_8kHzStereo', 'LONG_PTR',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTDataKey',
    'IEnumString', 'SVEAllEvents', 'SLTApp',
    'SpeechPropertyResponseSpeed', 'SDTAudio', 'SAFTDefault',
    'SPBOOKMARKOPTIONS', 'DISPID_SLWPronunciations',
    'SAFT24kHz16BitMono', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRCResume', 'DISPID_SPILanguageId',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_MIN_SR',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechPhraseRule',
    'SREStateChange', 'SLOStatic', 'IInternetSecurityMgrSite',
    'DISPID_SRCCreateResultFromMemory', 'SP_VISEME_10',
    'DISPID_SPPsCount', 'DISPID_SRCSetAdaptationData', 'SRSEDone',
    'SPLOADOPTIONS', 'DISPID_SRCVoice', 'DISPID_SOTsItem',
    '_ISpeechRecoContextEvents', 'SpeechPropertyComplexResponseSpeed',
    'SAFT22kHz8BitMono', 'SpShortcut', 'eLEXTYPE_PRIVATE19',
    'SPSInterjection', 'DISPID_SMSSetData', 'SPSUnknown',
    ...
    'eLEXTYPE_APP', 'SAFT22kHz16BitStereo', 'SPWT_PRONUNCIATION',
    'SVSFIsNotXML', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRsDynamic', 'ISpeechLexicon',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechFileStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPPHRASE',
    'SpeechWordPronounceable', 'DISPID_SDKSetBinaryValue',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SGLexicalNoSpecialChars',
    'SVF_Stressed', 'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE14',
    ...
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRAudioInputStream',
    'ISpeechRecoResultTimes', 'ISpNotifySink', 'SPPS_Interjection',
    'SECHighConfidence', 'DISPID_SRCEEnginePrivate',
    'SpeechGrammarTagWildcard', 'DISPID_SPIReplacements',
    'SDTLexicalForm', 'DISPID_SVPause', 'SpeechGrammarWordType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_PRIVATE17',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPEEngineConfidence',
    'DISPID_SMSGetData', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPELexicalForm', 'SPSVerb', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE1', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPPParent', 'SPAS_RUN', 'DISPID_SOTCDefault',
    'ISpeechBaseStream', 'DISPID_SPEsItem', 'SVSFPersistXML',
    'DISPID_SFSClose', 'ISpShortcut', 'SAFTADPCM_44kHzStereo',
    'SSSPTRelativeToStart', 'DISPID_SRCERequestUI',
    'ISpeechRecoResultDispatch', 'SPXRO_SML', 'ISpNotifyTranslator',
    'SPEI_START_INPUT_STREAM', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPGRAMMARSTATE', 'SpeechFormatType', 'SPGS_ENABLED',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechXMLRecoResult',
    'SVSFParseAutodetect', 'DISPID_SFSOpen', 'SAFT16kHz16BitStereo',
    'SVSFIsXML', 'SRAONone', 'DISPID_SGRAttributes',
    ...
    'SpeechVoicePriority', 'SpPhraseInfoBuilder', 'SDKLCurrentUser',
    'SPAS_CLOSED', 'SRERequestUI', 'DISPID_SRCCreateGrammar',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPAsItem',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCEAudioLevel',
    'DISPIDSPTSI', 'ISpeechGrammarRule',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVIsUISupported',
    'DISPID_SRSAudioStatus', 'SPRST_NUM_STATES',
    'DISPID_SRRRecoContext', 'DISPID_SGRSTPropertyName',
    'ISpeechVoice', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRsAdd', 'ISpResourceManager',
    'DISPID_SASState', 'SpStream', 'DISPID_SOTCategory',
    'SWPKnownWordPronounceable', 'DISPID_SVEEnginePrivate',
    'DISPID_SRGIsPronounceable', 'DISPID_SRRSetTextFeedback',
    'SpCustomStream', 'ISpEventSource', 'SPLO_DYNAMIC',
    'SPBO_TIME_UNITS', 'DISPID_SPRuleFirstElement', 'ISpEventSink',
    'SpeechGrammarTagDictation', 'SpeechEngineConfidence',
    'SPAUDIOSTATUS', 'SPVPRIORITY', 'SpeechAudioProperties',
    'DISPID_SPEDisplayText'
]

_check_version('1.4.0', 1701670864.267664)
